...
public class AstarDebugStepVisual : MonoBehaviour
{
    public static AstarDebugStepVisual Instance { get; private set; }

    [SerializeField] private Transform pfGridTile;
    ...
    {
        Transform visualNodeTransform = Instantiate(pfGridTile, position, Quaternion.identity);
