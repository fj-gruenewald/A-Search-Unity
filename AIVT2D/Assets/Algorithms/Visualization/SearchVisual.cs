...
public class SearchVisual : MonoBehaviour {
    ...
    public void SetGrid(Grid<AstarPathNode> grid) {
        this.grid = grid;
        UpdateVisual();
    ...
    private void Grid_OnGridValueChanged(object sender, Grid<AstarPathNode>.OnGridObjectChangedEventArgs e) {
        updateMesh = true;
    }
